...
\def\xxfigures{
\begin{center}
\includegraphics[height=4cm]{Cours/images/smartphone.png} \\
\includegraphics[height=4cm]{Cours/images/petrole.png} \\
\includegraphics[height=4cm]{Cours/images/gaz.png} \\
\end{center}
...
\begin{defi}
  Une masse \textbf{m} se déplacement dans un mouvement de \textbf{translation} à une vitesse \textbf{v} dispose d'une énergie cinétique \trou{$E_c = \frac{1}{2}m\times v^2$ avec m en kg et v en m/s}.   
\end{defi}
...
\begin{center}
\vspace{0.3cm}
    \includegraphics[width=0.8\textwidth]{Cours/images/Chainefonctionnelcomplete.png}
    \vspace{0.3cm}
\end{center}
